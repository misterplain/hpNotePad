const templatesEbayGeneral = [
  ...
  {
    id: 20,
    text: "All HP Store printers will come with starter ink included. You may find further information related to this device under the full product specs by performing a search for the printer on the HP Online Store.\nhttps://www.hp.com/gb-en/shop/ ",
  },
  {
    id: 8,
...
const templatesEbayOrderStatus = [
  {
    id: 20,
    text: "Our records show that your order has been delivered.\n\nOur apologies for the delays and inconvenience seen with this order. ",
  },
  {
    id: 21,
    text: "Our records show that your order has been shipped to the courier and is out for delivery today. Please see your tracking link below:\n\nOur apologies for the delays and inconvenience seen with this order. ",
  },
  {
    id: 22,
  ...
  {
    id: 3,
    text: "Unfortunately there was an error processing this order and it is being fully cancelled. You'll be notified automatically once this is complete. This will not ship and you will not be fully charged. If there is a charge on your end currently, it will be fully refunded.",
  },
  {
    id: 4,
...
export { templatesEbayGeneral, templatesEbayOrderStatus, templatesEbayReturns };
